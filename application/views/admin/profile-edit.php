...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('profiles'); ?>">Profile</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form id="defaultForm" method="post" class="" action="<?php echo base_url('profiles/editpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="phone" id="phone" value="<?php echo isset($userdetails['mobile'])?$userdetails['mobile']:''; ?>" placeholder="Enter Phone  number" />
								</div>
							</div>
                        </div>
						<div class="col-md-6">
