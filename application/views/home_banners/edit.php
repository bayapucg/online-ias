...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('banners/lists'); ?>">Home Banner List</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form id="addflyer" method="post" class="" action="<?php echo base_url('banners/editpost'); ?>" enctype="multipart/form-data">
							<?php $csrf = array(
								'name' => $this->security->get_csrf_token_name(),
								'hash' => $this->security->get_csrf_hash()
						); ?>
					<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
					<input type="hidden" class="form-control" name="b_id" id="b_id" value="<?php echo isset($details['b_id'])?$details['b_id']:''; ?>" />
						...
						<div class="clearfix">&nbsp;</div>
						  <div class="form-group">
                            <div class="col-lg-4 col-lg-offset-8">
								...
								<a href="<?php echo base_url('banners/lists'); ?>" type="submit" class="btn btn-warning" >Cancel</a>
